...
Local $local_path = "D:\dwn\RetroPie"
...
$main_gui = GUICreate($app_name & " " & $app_version, 800, 340)
...
GUICtrlCreateGroup("Paths to Synchronise", 10, 130, 780, 150)
...
Global $path_1_local_input = GUICtrlCreateInput("D:\RetroPie\boot", 70, $path_1_y, 250)
...
Global $path_2_local_input = GUICtrlCreateInput("D:\RetroPie\home\pi\GPIOnext", 70, $path_2_y, 250)
...
Global $path_3_local_input = GUICtrlCreateInput("D:\RetroPie\home\pi\RetroPie\BIOS", 70, $path_3_y, 250)
...
Global $path_4_local_input = GUICtrlCreateInput("D:\RetroPie\opt\retropie\configs", 70, $path_4_y, 250)
...
Global $path_5_local_input = GUICtrlCreateInput("D:\RetroPie\home\pi\RetroPie\roms", 70, $path_5_y, 250)
...
Global $mirror_button = GUICtrlCreateButton("WinSCP Mirror", 20, 285, 140)

Global $status_input = GUICtrlCreateInput("", 10, 340 - 25, 800 - 20, 20, $ES_READONLY, $WS_EX_STATICEDGE)
...
While True
	...
	Switch $msg
		...
		Case $mirror_button
			...
			Local $winscp_script = "open scp://" & GUICtrlRead($winscp_username_input) & ":" & GUICtrlRead($winscp_password_input) & "@" & GUICtrlRead($winscp_hostname_input) & "/ -hostkey=""" & GUICtrlRead($winscp_hostkey_input) & """ -rawsettings Shell=""sudo%20su%20-""" & @CRLF
